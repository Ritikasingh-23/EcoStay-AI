...
function AboutPage() {
  ...
  let firstAboutCard = (
    <div className="bg-green-50 p-6 rounded-lg border border-green-200"> 
      <h3 className="text-xl font-bold mb-2 text-green-800">{featuresList[0].title}</h3> 
      <p className="text-gray-600">{featuresList[0].description}</p> 
    </div>
  );
  let secondAboutCard = (
    <div className="bg-green-50 p-6 rounded-lg border border-green-200"> 
      <h3 className="text-xl font-bold mb-2 text-green-800">{featuresList[1].title}</h3> 
      <p className="text-gray-600">{featuresList[1].description}</p> 
    </div>
  );
  let thirdAboutCard = (
    <div className="bg-green-50 p-6 rounded-lg border border-green-200"> 
      <h3 className="text-xl font-bold mb-2 text-green-800">{featuresList[2].title}</h3> 
    ...
    <>
      ...
      <main className="flex-1 py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl font-bold mb-6 text-green-900">{websiteContent.aboutTitle}</h1>
